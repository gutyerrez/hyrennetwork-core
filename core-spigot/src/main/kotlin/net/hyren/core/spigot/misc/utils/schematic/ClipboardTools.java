...
public class ClipboardTools {
    ...
    public static void pasteClipboard(Location location, Clipboard clipboard) {
     ...
     */
    public static List<Chunk> getNMSChunksRelative(Clipboard clipboard, Location pasteLocation) {
     ...
     * @return a Set containing the chunks within the bounds.
     */
    public static Set<org.bukkit.Chunk> getBukkitChunksRelative(Clipboard clipboard, Location pasteLocation) {
     ...
     */
    public static Set<int[]> getChunkCoordsRelative(Clipboard clipboard, Location pasteLocation) {
